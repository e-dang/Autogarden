...
TEST_F(DigitalPinTest, getPin) { EXPECT_EQ(pin->getPin(), pinNum); }

TEST_F(DigitalPinTest, isConnectedIsInitiallyFalse) { EXPECT_FALSE(pin->isConnected()); }
...
TEST_F(DigitalPinTest, getValue) { EXPECT_EQ(pin->getValue(), value); }
...
TEST_F(DigitalPinTest, getModeReturnsDigital) { EXPECT_EQ(pin->getMode(), PinMode::Digital); }

...
#include <components/microcontroller/factory.hpp>
#include <components/microcontroller/microcontroller.hpp>
#include <components/moisture_sensor/factory.hpp>
#include <components/moisture_sensor/moisture_sensor.hpp>
#include <components/multiplexer/factory.hpp>
#include <components/multiplexer/multiplexer.hpp>
#include <components/pump/factory.hpp>
#include <components/pump/pump.hpp>
#include <components/shift_register/factory.hpp>
#include <components/shift_register/shift_register.hpp>
#include <components/valve/factory.hpp>
